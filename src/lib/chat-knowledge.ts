...
const CORE_KNOWLEDGE: KnowledgeChunk[] = [
  ...
  },
  {
    ...
    content: "適合確認と範囲確定後、Wise、銀行振込、USDC、クレジットカード（Stripe請求書または決済リンク）の支払案内を発行します。請求書で手数料、USDCのネットワークとウォレットを確認します。入金、必要素材・アクセス、承認者が揃った日を開始日として記録し、合意した固定セットアップを開始日から14営業日以内に納品できない場合は13,000ドルを全額返金します。顧客側の追加変更や保留は記録して時計を一時停止します。",
  },
  {
    locale: "en",
