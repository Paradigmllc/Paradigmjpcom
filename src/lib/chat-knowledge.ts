...
const CORE_KNOWLEDGE: KnowledgeChunk[] = [
  ...
  },
  {
    ...
    href: "/en/pricing",
    keywords: ["price", "pricing", "cost", "fee", "monthly", "setup", "15,000", "15000", "2,000", "2000", "12,000", "12000", "six", "month", "campaign", "waived", "selected"],
  ...
  },
  {
    ...
    href: "/ja/pricing",
    keywords: ["料金", "費用", "価格", "セットアップ", "15000", "15,000", "月額", "6か月", "継続"],
    content: "セットアップは15,000ドル固定です。選定した契約先には、標準月額2,000ドルの運用を6か月分、追加月額なしで含めます（2,000ドル×6か月＝12,000ドル相当）。期間終了後の継続条件・月額は個別に協議し、書面で合意します。第三者費用と合意外の作業は別です。",
  },
  {
    locale: "en",
