...
const CORE_KNOWLEDGE: KnowledgeChunk[] = [
  ...
  },
  {
    ...
    href: "/en/pricing",
    keywords: ["price", "pricing", "cost", "fee", "monthly", "setup", "15,000", "15000", "2,000", "2000", "6,000", "6000", "90", "days", "campaign", "selected"],
    content: "$15,000 USD fixed one-time setup. For selected launch partners, the standard managed-operation fee of $2,000/month is included for Days 1–90 at no additional monthly charge: $2,000/month × 3 months = $6,000 of managed-operation value. Month 4 onward is $2,000/month under the signed terms. Third-party costs and approved work outside scope remain separate.",
  },
  {
    locale: "ja",
    title: "Japan Entryの料金と契約条件",
    href: "/ja/pricing",
    keywords: ["料金", "費用", "価格", "セットアップ", "15000", "15,000", "月額", "3か月", "90日", "継続"],
    content: "セットアップは15,000ドル固定です。選定した契約先には、標準月額2,000ドルの運用を3か月分、追加月額なしで含めます（2,000ドル×3か月＝6,000ドル相当）。期間終了後の継続条件・月額は個別に協議し、書面で合意します。第三者費用と合意外の作業は別です。",
  },
  {
    locale: "en",
  ...
  },
  {
    ...
    content: "適合確認と範囲確定後、Wise、銀行振込、USDC、クレジットカード（Stripe請求書または決済リンク）の支払案内を発行します。請求書で手数料、USDCのネットワークとウォレットを確認します。入金、必要素材・アクセス、承認者が揃った日を開始日として記録し、合意した固定セットアップを開始日から14営業日以内に納品できない場合は15,000ドルを全額返金します。顧客側の追加変更や保留は記録して時計を一時停止します。",
  },
  {
    locale: "en",
