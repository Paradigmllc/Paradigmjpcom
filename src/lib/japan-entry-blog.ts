...
The Start Date is recorded after written scope acceptance, cleared payment, complete source materials, required account access, and one empowered approver. The guarantee covers the agreed implementation work and documented handover. If that fixed setup is not delivered within 14 business days from the Start Date, 100% of the $15,000 setup fee is refunded. Client-requested changes or holds are logged and pause the clock. This is a delivery guarantee, not a promise of ranking, traffic, conversion, or revenue.
