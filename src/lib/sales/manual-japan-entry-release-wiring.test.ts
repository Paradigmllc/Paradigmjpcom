...
describe("manual Japan Entry release wiring", () => {
  it("applies and verifies the dedicated table before deploy", () => {
    ...
    expect(doctor).toContain("manual Japan Entry workbench has grounded four-cell initial-interest copy")
    expect(doctor).toContain("manual copy experiment columns/outcome constraint/RLS/zero-send guard")
