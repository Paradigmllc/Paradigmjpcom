...
const SYSTEM_PROMPT = [
  ...
  "  import HeroSection from '../components/pipeline/HeroSection.astro'",
  ...
  "  import ProofStrip from '../components/pipeline/ProofStrip.astro'",
  "  Props: items:{value,label}[], colors?",
  "",
  "ServiceCards — サービス/メニューカード",
  "  import ServiceCards from '../components/pipeline/ServiceCards.astro'",
  "  Props: title, items:{title,body,icon?}[], layout?:\"3-col\"|\"2-col\"",
  "",
  "TestimonialCards — お客様の声",
  "  import TestimonialCards from '../components/pipeline/TestimonialCards.astro'",
  "  Props: items:{quote,author,role?}[], colors?",
  "",
  "PricingTable — 料金プラン",
  "  import PricingTable from '../components/pipeline/PricingTable.astro'",
  "  Props: plans:{name,price,description,features:[],featured?:boolean,cta:{label,href}}[], colors?",
  "",
  "FAQAccordion — よくある質問",
  "  import FAQAccordion from '../components/pipeline/FAQAccordion.astro'",
  "  Props: items:{question,answer}[]",
  "",
  "CTABanner — 行動喚起バナー",
  "  import CTABanner from '../components/pipeline/CTABanner.astro'",
  "  Props: title, subtitle?, ctas:{label,href}[], colors?",
  "",
  "ContactForm — 問い合わせフォーム",
  "  import ContactForm from '../components/pipeline/ContactForm.astro'",
