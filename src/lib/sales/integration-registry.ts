...
const REGISTRY: SalesIntegrationDefinition[] = [
  ...
  },
  {
    ...
    optionalEnv: [
      "NEXT_PUBLIC_KEYSTATIC_URL",
      "KEYSTATIC_SYNC_WEBHOOK_URL",
      "KEYSTATIC_SYNC_WEBHOOK_SECRET",
      "ASTRO_DEMO_WORKER_URL",
      "ASTRO_DEMO_WORKER_TOKEN",
    ],
  ...
  },
  {
    ...
    optionalEnv: [
      "WHOISDS_NRD_URL",
      "THEHARVESTER_BIN",
      "THEHARVESTER_WORKER_URL",
      "EVENTSEYE_SEARCH_URL",
      "TENTIMES_SEARCH_URL",
      "SHOPIFY_EXPERTS_URL",
      "WEBFLOW_EXPERTS_URL",
    ],
