...
export function initialInterestClose(options: JapanEntryInitialInterestOptions): string {
  ...
  const price = options.includePrice
    ? "Paradigm's fixed Japan Entry launch fee is $13,000, with the standard $2,000/month managed-operation layer included for six months ($2,000/month × 6 months = $12,000 of value) for selected launch partners. "
    : ""
