...
Paradigm addresses these items through our Japan Entry Package, which validates the opportunity and addresses the named customer-path gap. The package is $15,000 paid upfront, and the first 90 days of managed support are included at no additional monthly charge. Would a detailed Japan opportunity analysis be useful?`,
]
...
Paradigm addresses these items through our Japan Entry Package, which validates the opportunity and addresses the named customer-path gap. The package is $15,000 paid upfront, with the first 90 days of managed support included at no additional monthly charge. Would you like a detailed Japan opportunity analysis?`
  ...
  it("rejects the prior generic rank-led pattern", () => {
    ...
    const review = reviewPersonalizedJapanEntryMessage({
      message:
        "Hi Example team — I noticed your site has a Tranco rank of 52,000. Given that reach, Japan is a logical next step. Our Japan Entry Package is $15,000 paid upfront, with the first 90 days included. Is this relevant?",
      companyName: "Example",
      productContext,
      productEvidence,
