...
export const DEFAULT_CRM_VIEW_FIELDS: SalesCrmViewField[] = [
  ...
  { fieldKey: "lead_status", twentyFieldName: "paradigmLeadStatus", label: "候補ステータス", position: 2, isVisible: true, fieldType: "text", description: "DEMO候補・文面候補など営業前の確認状態" },
  { fieldKey: "demo_url", twentyFieldName: "paradigmDemoUrl", label: "デモURL", position: 3, isVisible: true, fieldType: "url", description: "7日限定DEMO URL" },
  { fieldKey: "sales_status", twentyFieldName: "paradigmSalesStatus", label: "営業ステータス", position: 5, isVisible: true, fieldType: "select", description: "営業の現在地" },
  { fieldKey: "form_url", twentyFieldName: "paradigmFormUrl", label: "フォームURL", position: 6, isVisible: true, fieldType: "url", description: "フォーム営業対象URL" },
  { fieldKey: "outreach_target_url", twentyFieldName: "paradigmOutreachTargetUrl", label: "営業先URL", position: 9, isVisible: true, fieldType: "url", description: "実際に開いて提案する掲載ページまたは確認済みフォーム" },
  { fieldKey: "country", twentyFieldName: "paradigmCountryName", label: "国名", position: 7, isVisible: true, fieldType: "text", description: "対象国。Twenty再起動で選択肢が失われない自由入力表示" },
  { fieldKey: "region", twentyFieldName: "paradigmRegionName", label: "地域名", position: 8, isVisible: true, fieldType: "text", description: "国別の地域候補はSales OSの選択肢マスタで管理し、Twentyには確定した地域名だけを表示" },
  { fieldKey: "industry", twentyFieldName: "paradigmIndustryName", label: "業種名", position: 9, isVisible: true, fieldType: "select", description: "営業テンプレ選定に使う業種" },
  { fieldKey: "source", twentyFieldName: "paradigmSourceName", label: "ソース元", position: 10, isVisible: true, fieldType: "select", description: "Apollo、Fumadataなどの取得元" },
  { fieldKey: "report_url", twentyFieldName: "paradigmReportUrl", label: "診断レポートURL", position: 11, isVisible: true, fieldType: "url", description: "顧客向け診断ページ" },
  { fieldKey: "sales_material_url", twentyFieldName: "paradigmSalesMaterialUrl", label: "営業資料URL", position: 12, isVisible: true, fieldType: "url", description: "Slidev/Gotenberg資料" },
  { fieldKey: "customer_portal_url", twentyFieldName: "paradigmCustomerPortalUrl", label: "顧客ポータルURL", position: 13, isVisible: true, fieldType: "url", description: "成約後の顧客ポータル" },
]

const OPERATIONAL_CRM_VIEW_FIELDS: SalesCrmViewField[] = [
  { fieldKey: "next_action", twentyFieldName: "paradigmNextAction", label: "Next Action", position: 4, isVisible: true, fieldType: "text", description: "Next required pipeline action" },
  { fieldKey: "data_status", twentyFieldName: "paradigmDataStatus", label: "取得ステータス", position: 14, isVisible: true, fieldType: "text", description: "Twenty Sales OS readiness and data collection state" },
  { fieldKey: "last_error", twentyFieldName: "paradigmLastError", label: "最終エラー", position: 15, isVisible: true, fieldType: "text", description: "Latest source or pipeline error summary" },
]
...
const CRM_FIELD_OVERRIDES: Record<string, Partial<SalesCrmViewField>> = {
  ...
  lead_status: { label: "候補ステータス", position: 2, isVisible: true, fieldType: "text" },
  demo_url: { label: "デモURL", position: 3, isVisible: true },
  next_action: { label: "Next Action", position: 4, isVisible: true },
  sales_status: { label: "営業ステータス", position: 5, isVisible: true },
  form_url: { label: "フォームURL", position: 6, isVisible: true },
  outreach_target_url: { label: "営業先URL", position: 9, isVisible: true, fieldType: "url", description: "実際に開いて提案する掲載ページまたは確認済みフォーム" },
  country: { label: "国名", position: 7, isVisible: true, fieldType: "text", description: "対象国。Twenty再起動で選択肢が失われない自由入力表示" },
  region: { label: "地域名", position: 8, isVisible: true, fieldType: "text" },
  industry: { label: "業種名", position: 9, isVisible: true },
  source: { label: "ソース元", position: 10, isVisible: true },
  report_url: { label: "診断レポートURL", position: 11, isVisible: true },
  sales_material_url: { label: "営業資料URL", position: 12, isVisible: true },
  customer_portal_url: { label: "顧客ポータルURL", position: 13, isVisible: true },
  data_status: { label: "取得ステータス", position: 14, isVisible: true },
  last_error: { label: "最終エラー", position: 15, isVisible: true },
}
