...
export const DEFAULT_CRM_VIEW_FIELDS: SalesCrmViewField[] = [
  ...
  { fieldKey: "country", twentyFieldName: "paradigmCountryName", label: "国名", position: 7, isVisible: true, fieldType: "select", description: "対象国" },
...
const CRM_FIELD_OVERRIDES: Record<string, Partial<SalesCrmViewField>> = {
  ...
  country: { label: "国名", position: 7, isVisible: true, fieldType: "select", description: "対象国" },
