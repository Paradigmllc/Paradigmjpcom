...
const CRM_FIELD_OVERRIDES: Record<string, Partial<SalesCrmViewField>> = {
  ...
  source_coverage: { label: "50+ API/OSS取得率", position: 3, isVisible: true },
  data_sources: { label: "取得ソース数", position: 4, isVisible: true },
  data_breakdown: { label: "50+ API/OSS内訳", position: 5, isVisible: true },
  source_details_url: { label: "50+ API/OSS詳細URL", position: 6, isVisible: true, fieldType: "url" },
  data_status: { label: "取得ステータス", position: 7, isVisible: true },
  next_action: { label: "Next Action", position: 8, isVisible: true },
  last_error: { label: "最終エラー", position: 9, isVisible: true },
  sales_status: { label: "営業ステータス", position: 10, isVisible: true },
  form_url: { label: "フォームURL", position: 11, isVisible: true },
  report_url: { label: "診断レポートURL", position: 12, isVisible: true },
  region: { label: "地域名", position: 13, isVisible: true, fieldType: "text" },
  industry: { label: "業種名", position: 14, isVisible: true },
  source: { label: "ソース元", position: 15, isVisible: true },
  sales_material_url: { label: "営業資料URL", position: 16, isVisible: true },
  demo_url: { label: "デモURL", position: 17, isVisible: true },
  customer_portal_url: { label: "顧客用Notion URL", position: 18, isVisible: true },
}
