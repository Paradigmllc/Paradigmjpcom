...
const VARIANT_DEMO_DATA: Record<string, VariantDemoData> = {
  japan_entry: {
    ...
    cta: {
      ja: "固定範囲、15,000米ドルの承認時期、必要素材、開始日から14営業日の納品保証条件を申込み前に書面で確認します。",
      en: "Apply to confirm fit, the fixed $15,000 scope, approval timing, required inputs, and the Start Date behind the 14-business-day delivery guarantee.",
    },
  },
  website_diagnostic: {
