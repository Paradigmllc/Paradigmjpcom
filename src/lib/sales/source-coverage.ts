...
const SOURCES: SourceDefinition[] = [
  ...
  { slug: "hyperframes", label: "HyperFrames", category: "video", env: ["HYPERFRAMES_RENDERER_URL", "HYPERFRAMES_API_URL"], detect: (m) => !!m.hyperframes, detail: "HTML-first sales video compositions and motion templates" },
