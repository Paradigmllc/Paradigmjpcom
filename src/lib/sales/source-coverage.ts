...
const SOURCES: SourceDefinition[] = [
  ...
  { slug: "chatwoot", label: "Chatwoot", category: "post_outreach", env: ["CHATWOOT_BASE_URL", "CHATWOOT_API_KEY", "CHATWOOT_ACCOUNT_ID", "CHATWOOT_WEBHOOK_URL", "N8N_POST_OUTREACH_WEBHOOK_URL"], detect: (m) => !!m.chatwoot || !!m.post_outreach_reply, detail: "Unified inbox and AI reply handoff for landed outreach" },
  ...
  { slug: "livekit", label: "LiveKit", category: "post_outreach", env: ["LIVEKIT_URL", "LIVEKIT_API_KEY", "LIVEKIT_API_SECRET", "LIVEKIT_WEBHOOK_URL", "N8N_LIVEKIT_DISCOVERY_WEBHOOK_URL"], detect: (m) => !!m.livekit || !!m.discovery_call, detail: "Realtime AI discovery-call lane and transcript capture" },
  ...
  { slug: "pytrends", label: "Pytrends OSS", category: "analysis", env: ["PYTRENDS_WORKER_URL"], detect: (m) => !!m.pytrends, detail: "Search trend interest by market and industry" },
