...
function brief(): ManualEditorialBrief {
  return {
    ...
    pages: [
      { url: "https://northstar.example", kind: "home", title: "Northstar Workspace", description: null, headings: ["Build a workspace that changes with the project"], snippets: [] },
      { url: "https://northstar.example/products", kind: "product", title: "Northstar Rail System", description: null, headings: ["Rail System"], snippets: [] },
    ],
    evidence: [
