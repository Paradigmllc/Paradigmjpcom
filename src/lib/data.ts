...
const SERVICES_JA: readonly Service[] = [
  ...
  },
  {
    ...
    features: ["AIチャットボット構築", "業務自動化（n8n/Dify）", "AIコンテンツ生成", "データ分析・可視化", "社内AI研修", "カスタムAI開発"],
...
const SERVICES_EN: readonly Service[] = [
  ...
  },
  {
    ...
    features: ["AI chatbot deployment", "Workflow automation (n8n/Dify)", "AI content generation", "Analytics & dashboards", "In-house AI training", "Custom AI development"],
