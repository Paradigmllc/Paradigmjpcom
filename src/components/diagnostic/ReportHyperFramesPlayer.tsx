...
export default function ReportHyperFramesPlayer({ src, lang }: { src: string; lang: ReportLang }) {
  ...
  return (
    <div ref={frameRef} data-diagnostic-hf-root data-hf-speed={speed} className="relative overflow-hidden rounded-2xl border border-zinc-200 bg-zinc-950 shadow-lg">
      ...
      <div className="relative z-20 grid gap-2 rounded-xl border border-white/15 bg-zinc-950 px-2 py-2 text-white shadow-2xl sm:absolute sm:inset-x-3 sm:bottom-3 sm:grid-cols-[auto_1fr_auto] sm:items-center sm:gap-3 sm:rounded-2xl sm:bg-zinc-950/88 sm:px-4 sm:py-3 sm:backdrop-blur">
        ...
        <label className="grid grid-cols-[auto_1fr_auto] items-center gap-2 text-[11px] font-semibold text-zinc-300 sm:gap-3 sm:text-xs">
