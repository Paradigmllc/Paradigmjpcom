        ...
        >
          ...
          <p className="mt-3 text-sm text-zinc-500 max-w-2xl mx-auto">
            {lang === "ja"
              ...
              : `One $12,000 setup scope, with dependencies, acceptance checks, exclusions, and third-party costs confirmed in writing before payment.`}
          </p>
        </motion.div>
            ...
            <div className={`rounded-xl p-5 ${lang === "ja" ? "bg-violet-50" : "bg-violet-50"}`}>
              ...
              <div className="space-y-3">
                {[
                  ...
                  { step: "3", label: lang === "ja" ? "合意範囲の実装・検証" : "Implement and verify the fixed scope", time: lang === "ja" ? "書面で確定" : "21-business-day target" },
