          ...
          >
            {requestSent ? (
              <div className="text-center py-8">
                ...
                <button onClick={() => setRequestOpen(false)} className="mt-6 text-sm text-violet-600 hover:underline">{lang === "ja" ? "閉じる" : "Close"}</button>
              </div>
            ) : (
              <>
                ...
                <div className="space-y-3">
                  <input value={requestForm.company} onChange={e => setRequestForm({...requestForm, company: e.target.value})} placeholder={lang === "ja" ? "会社名" : "Company name"} className="w-full rounded-lg border border-zinc-200 px-3 py-2 text-sm outline-none focus:border-violet-500" />
                  <input value={requestForm.name} onChange={e => setRequestForm({...requestForm, name: e.target.value})} placeholder={lang === "ja" ? "お名前" : "Your name"} className="w-full rounded-lg border border-zinc-200 px-3 py-2 text-sm outline-none focus:border-violet-500" />
                  <input value={requestForm.email} onChange={e => setRequestForm({...requestForm, email: e.target.value})} type="email" placeholder="Email" className="w-full rounded-lg border border-zinc-200 px-3 py-2 text-sm outline-none focus:border-violet-500" />
                  <div className="pt-2">
