...
export function DemoPremiumV3ContactPage({ data }: { data: DemoMultiPageData }) {
  ...
  const hero = media[2] ?? premium.heroMedia[0]
  ...
  return (
    <div className="overflow-hidden bg-[var(--demo-surface)] text-[var(--demo-ink)]">
      <PremiumV3PageHero title={contact.title} subtitle={contact.subtitle} eyebrow={direction.labels.information} media={hero} mediaGallery={direction.hero === "mosaic" ? media : undefined} recipe={data.designRecipe} variant={direction.hero} />
