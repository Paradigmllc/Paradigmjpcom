      ...
      <header className="bg-[var(--demo-ink)] px-5 pb-16 pt-28 text-white sm:px-10 sm:pb-20 sm:pt-32 lg:px-16 lg:pb-24">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.18fr_.82fr] lg:items-end">
          <PremiumV3Reveal motionStyle={motionStyle}>
            ...
            <h1 className="mt-7 max-w-[13em] text-[clamp(2.7rem,5.4vw,5.8rem)] font-[var(--demo-heading-weight)] leading-[1.02] tracking-[-.04em] text-balance [font-family:var(--demo-font-display)]">{contact.title}</h1>
          </PremiumV3Reveal>
