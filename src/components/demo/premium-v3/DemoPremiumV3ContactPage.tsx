...
export function DemoPremiumV3ContactPage({ data }: { data: DemoMultiPageData }) {
  ...
  return (
    <div className="overflow-hidden bg-[var(--demo-surface)] text-[var(--demo-ink)]">
      <PremiumV3PageHero title={contact.title} subtitle={contact.subtitle} eyebrow={direction.labels.information} media={hero} recipe={data.designRecipe} variant={direction.hero} />
