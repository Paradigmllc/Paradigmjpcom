      ...
      {splitHero ? <section className={`grid min-h-[660px] bg-[var(--demo-surface)] ${editorialSplit ? "lg:grid-cols-[.72fr_1.28fr]" : "lg:grid-cols-[.92fr_1.08fr]"}`}>
        ...
        <div className="relative mx-auto flex min-h-[620px] max-w-[1500px] flex-col justify-end px-5 pb-14 pt-28 text-white sm:px-10 sm:pb-18 lg:min-h-[calc(100svh-4.9rem)] lg:px-16 lg:pb-20">
          <PremiumV3Reveal motionStyle={motionStyle}>
            ...
            <h1 className="max-w-4xl text-[clamp(2.7rem,5.2vw,5.3rem)] font-[var(--demo-heading-weight)] leading-[1.01] tracking-[-.035em] text-balance [font-family:var(--demo-font-display)]"><PremiumV3TextLines text={home.hero.title} /></h1>
