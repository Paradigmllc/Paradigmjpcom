...
export function DemoPremiumV3BeautyHome({ data }: { data: DemoMultiPageData }) {
  ...
  return (
    <div className="overflow-hidden bg-[var(--demo-surface)] text-[var(--demo-ink)] [font-feature-settings:'palt']">
      <section className="grid min-h-[680px] lg:grid-cols-[.46fr_.54fr]">
        <div className="relative flex items-end px-5 pb-14 pt-24 sm:px-10 sm:pb-20 lg:px-16 lg:pb-24">
          ...
          <PremiumV3Reveal motionStyle={motionStyle} className="max-w-3xl">
            ...
            <h1 className={`${demoHeadlineClass(home.hero.title, "hero")} max-w-[13em] font-[var(--demo-heading-weight)] text-balance [font-family:var(--demo-font-display)]`}><PremiumV3TextLines text={home.hero.title} /></h1>
        ...
        <div className="relative min-h-[520px] overflow-hidden bg-[var(--demo-surface-alt)] lg:min-h-[680px]">
          <PremiumV3Parallax className="absolute -inset-y-12 inset-x-0"><PremiumV3Media media={hero} priority className="absolute inset-0" sizes="(max-width:1024px) 100vw, 54vw" /></PremiumV3Parallax>
          <div className="absolute inset-0 bg-gradient-to-t from-black/45 via-transparent to-transparent" />
          <div className="absolute inset-x-5 bottom-5 flex items-end justify-between border-t border-white/45 pt-4 text-white sm:inset-x-8 sm:bottom-8">
            <p className="max-w-sm text-sm leading-7 text-white/82">{hero.caption ?? hero.alt}</p>
            <span className="text-[10px] font-bold tracking-[.28em] text-white/62">01 / SALON</span>
          </div>
        </div>
      </section>
      ...
      <section className="grid bg-[var(--demo-surface-alt)] lg:grid-cols-[.45fr_.55fr]">
        <div className="group relative min-h-[480px] overflow-hidden lg:min-h-[760px]"><PremiumV3Parallax className="absolute -inset-y-12 inset-x-0"><PremiumV3Media media={secondary} className="absolute inset-0" sizes="(max-width:1024px) 100vw, 46vw" /></PremiumV3Parallax><div className="absolute inset-0 bg-gradient-to-t from-black/42 via-transparent to-transparent" /></div>
