...
const COPY: Record<LocaleVariant, HomeCopy> = {
  ja: {
    ...
    ctaTitle: "今のサイトを、営業が動く資産に変えましょう。",
    ctaBody: "まずは現状のWeb・検索・問い合わせ導線を確認し、最短で直すべき箇所を整理します。",
  },
  en: {
    ...
    ctaTitle: "Turn your site into an asset your sales process can actually use.",
    ctaBody: "We will review your web, search, and inquiry flow, then identify the fastest fixes.",
  },
}
