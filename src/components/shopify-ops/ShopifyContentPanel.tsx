...
import type { ShopifyOpsContentItem, ShopifyOpsProduct } from "@/lib/shopify-ops/types"
              ...
              <article key={item.id} className="p-5 sm:p-6">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                  <div className="min-w-0">
                    ...
                    <p className="mt-3 text-sm font-semibold leading-relaxed text-zinc-900">{item.hook}</p>
