...
import { CheckCircle2, ExternalLink, Loader2, RotateCcw, ShieldCheck, StopCircle, XCircle } from "lucide-react"
...
export function LeadCandidateReviewPanel({ runId, operatorName, onChanged }: LeadCandidateReviewPanelProps) {
  ...
  return <Card>
    <CardHeader>
      ...
      <CardDescription>決定論的ゲート通過後も自動昇格しません。根拠ページとフォームを確認し、最大20件ずつ明示承認した企業だけをTwentyへ同期します。</CardDescription>
    </CardHeader>
