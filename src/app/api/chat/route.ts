...
書面での範囲確定、入金、必要素材・アクセス、承認者が揃った開始日から14営業日以内に合意したセットアップを納品できない場合、セットアップ費用13,000ドルを全額返金します。顧客側の追加変更・保留は記録して時計を一時停止します。
...
- Setup: USD $13,000 fixed, paid before kickoff.
