...
const DB_JP = process.env.NOTION_CUSTOMERS_DB_ID ?? "86b1d93e3b854862ae7b2750d2585677"
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error("[sync-customers-from-notion] failed to parse request body:", e)
    body = {}
  }
