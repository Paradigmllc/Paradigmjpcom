...
const FAQS: SeedFaq[] = [
  ...
  },
  {
    ...
    answer: {
      ...
      en: "Three differences: ① a fixed-scope Japanese revenue and inquiry path, ② payment, disclosure, and operating dependencies confirmed before kickoff, and ③ a fixed $12,000 setup with the first six months of managed operation included for selected launch partners at no additional monthly charge. Sales outcomes are not guaranteed.",
    },
    category: { ja: "お申し込み前", en: "Before Ordering" },
    sortOrder: 18,
  },
