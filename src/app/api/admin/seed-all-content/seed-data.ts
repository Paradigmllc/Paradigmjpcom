    ...
    const layoutJa = [
      {
        ...
        badge: "意思決定の速い企業向け Japan Entry",
        title: "日本市場への展開を、実行できる計画に変える",
        subtitle: "セットアップ費用は12,000ドル固定。月額運用は最初の6か月無料。必要条件が揃う企業だけを審査し、21営業日の公開目標で進めます。",
        primaryCta: { label: "Japan Entry 適合審査 — $12K", href: "/contact?intent=japan-entry" },
        secondaryCta: { label: "固定オファーを見る", href: "#japan-entry-pricing" },
      },
      {
        blockType: "marquee",
        items: [
      ...
      },
      {
        blockType: "section",
        kicker: "SERVICES",
        title: "日本で売れるための導線を一気通貫で整える",
        subtitle: "日本語の訴求、信頼・法務情報、決済・問い合わせ導線、運用までを固定スコープで実装します。",
      ...
      {
        blockType: "pricing",
        id: "japan-entry-pricing", title: "Japan Entry 固定オファー", subtitle: "低価格パイロットや複数プランは用意しません。公開スコープに収まらない案件は受け付けません。",
        tiers: [
          { name: "Japan Entry Package", price: "$12,000", period: "one-time", description: "日本語の市場導線、実装、6か月の運用を含む固定スコープ。", features: "21営業日の公開目標\n日本語の販売・問い合わせ導線\n信頼・法務情報の調整\n適格な決済・問い合わせ経路\nAI支援と計測\n月額0ドル（最初の6か月）\n7か月目以降は月額995ドル", ctaLabel: "Japan Entry 適合審査 — $12K", ctaHref: "/contact?intent=japan-entry", highlighted: true },
        ],
      },
      {
        blockType: "cta",
        title: "日本市場への展開を、実装できる計画に変えます。",
        subtitle: "12,000ドル固定の範囲、依存条件、評価方法を確認し、適格な企業だけに実行スコープを提示します。",
        primaryCta: { label: "Japan Entry 適合審査 — $12K", href: "/contact?intent=japan-entry" },
        secondaryCta: { label: "固定オファーを見る", href: "#japan-entry-pricing" },
        background: "gradient",
      },
