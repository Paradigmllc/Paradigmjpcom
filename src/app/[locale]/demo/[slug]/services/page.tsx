...
import { DemoPremiumV3ServicesPage } from "@/components/demo/premium-v3/DemoPremiumV3ServicesPage"
...
export default async function DemoServicesServerPage({ params }: Props) {
  ...
  if (data.premium?.style === "premium-v3") return <DemoPremiumV3ServicesPage data={data} />
