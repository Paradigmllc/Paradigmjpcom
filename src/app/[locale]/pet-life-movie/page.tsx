...
const copy = {
  ja: { title: "写真を、家族の物語に。", description: "犬・猫の写真5〜20枚から、大切な記憶を事実のまま短編映画に。登録不要で無料プレビュー。", badge: "No account · Free preview", cta: "無料でつくる", sub: "写真は非公開。勝手な思い出をAIが作ることはありません。", steps: ["写真と本当にあった思い出を追加", "事実だけでストーリーボードを作成", "無料プレビューを見てから購入"], quality: "その子らしさを、最優先に。", qualityBody: "毛並みや顔立ちの一致度が基準を下回る生成映像は使わず、自然なズームとパララックスへ自動で戻します。", together: "みんなで思い出を持ち寄れる", togetherBody: "限定共有リンクで家族や友人と鑑賞。共同アップロードは次のリリースで同じプロジェクトに統合します。", oss: "透明なOSSパイプライン" },
  en: { title: "Turn photos into a family story.", description: "Create a private short film from 5–20 dog or cat photos and memories that really happened. No account needed for a free preview.", badge: "No account · Free preview", cta: "Create for free", sub: "Photos stay private. AI never invents memories about your pet.", steps: ["Add photos and real memories", "Build a factual storyboard", "Watch the preview before paying"], quality: "Their identity comes first.", qualityBody: "If generated motion cannot preserve facial features and fur patterns, the pipeline automatically falls back to gentle zoom and parallax.", together: "A story the family can share", togetherBody: "Watch through an unlisted link. Collaborative family uploads will join the same project in the next release.", oss: "Transparent OSS pipeline" },
  es: { title: "Convierte fotos en una historia familiar.", description: "Crea una película privada con 5–20 fotos de tu perro o gato y recuerdos reales. Vista previa gratis sin cuenta.", badge: "Sin cuenta · Vista previa gratis", cta: "Crear gratis", sub: "Tus fotos son privadas. La IA nunca inventa recuerdos.", steps: ["Añade fotos y recuerdos reales", "Crea un guion basado en hechos", "Mira la vista previa antes de pagar"], quality: "Su identidad es lo primero.", qualityBody: "Si el movimiento generado no conserva su rostro y pelaje, usamos zoom y paralaje suaves automáticamente.", together: "Una historia para compartir en familia", togetherBody: "Mírala mediante un enlace no listado. Las cargas colaborativas llegarán en la próxima versión.", oss: "Pipeline OSS transparente" },
  pt: { title: "Transforme fotos em uma história de família.", description: "Crie um filme privado com 5–20 fotos do seu cão ou gato e memórias reais. Prévia grátis sem conta.", badge: "Sem conta · Prévia grátis", cta: "Criar grátis", sub: "Suas fotos são privadas. A IA nunca inventa memórias.", steps: ["Adicione fotos e memórias reais", "Crie um roteiro baseado em fatos", "Veja a prévia antes de pagar"], quality: "A identidade do seu pet vem primeiro.", qualityBody: "Se o movimento gerado não preservar rosto e pelagem, voltamos automaticamente para zoom e paralaxe suaves.", together: "Uma história para toda a família", togetherBody: "Assista por um link não listado. Uploads colaborativos chegam na próxima versão.", oss: "Pipeline OSS transparente" },
} as const
    ...
    <main className="bg-paradigm-paper text-paradigm-ink">
      ...
      <section className="py-20 md:py-28">
        <div className="mx-auto grid max-w-6xl gap-6 px-5 md:grid-cols-2 md:px-8">
          <article className="rounded-3xl border border-paradigm-line bg-paradigm-paper-card p-8 shadow-sm md:p-10"><ShieldCheck className="mb-6 h-9 w-9 text-paradigm-accent" aria-hidden="true" /><h2 className="font-display text-3xl">{t.quality}</h2><p className="mt-4 leading-7 text-paradigm-ink-soft">{t.qualityBody}</p><div className="mt-7 flex flex-wrap gap-2 text-xs"><span className="rounded-full bg-paradigm-paper-deep px-3 py-2">No talking pets</span><span className="rounded-full bg-paradigm-paper-deep px-3 py-2">No voice cloning</span><span className="rounded-full bg-paradigm-paper-deep px-3 py-2">Factual captions only</span></div></article>
          <article className="rounded-3xl border border-paradigm-line bg-paradigm-paper-card p-8 shadow-sm md:p-10"><Users className="mb-6 h-9 w-9 text-paradigm-accent" aria-hidden="true" /><h2 className="font-display text-3xl">{t.together}</h2><p className="mt-4 leading-7 text-paradigm-ink-soft">{t.togetherBody}</p><div className="mt-7 flex items-center gap-2 text-sm font-medium"><Heart className="h-4 w-4 text-rose-500" aria-hidden="true" />Private · Unlisted · Delete anytime</div></article>
        </div>
      </section>
