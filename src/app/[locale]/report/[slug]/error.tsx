...
export default function ReportError({
  ...
  useEffect(() => {
    void captureException(error, {
      source: "[locale]/report/[slug]/error.tsx",
      severity: "error",
  ...
  return (
    <div className="min-h-dvh bg-[#fbfaf7] flex items-center justify-center p-8" role="alert">
      <div className="max-w-md text-center">
        ...
        <button type="button" onClick={reset} className="mt-6 inline-flex h-10 items-center justify-center rounded-lg bg-zinc-900 px-6 text-sm font-semibold text-white hover:bg-zinc-800">
          {t("retry")}
        </button>
      </div>
    </div>
