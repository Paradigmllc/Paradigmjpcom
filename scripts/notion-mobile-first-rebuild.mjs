...
function parentHubBlocks() {
  return [
    ...
    blk.cols2(
      ...
      [
        blk.navCard("Setup & Environment", "env / event webhook / Slack 設宁E, U("35fa2b78-f3fc-81dd-8dda-e455d1f20d09"), "🔧", "default"),
...
function pipelineBlocks() {
  return [
    ...
    blk.h2("Kanban Board"),
    blk.p("リーチEDB めENotion UI で「�Eード」view にして「商諁E��チE�Eジ」でグループ化。スチE�Eジ間ドラチE��で Supabase 自動反映 (webhook one-shot)、E),
    blk.linkedDb(DB.leadsJp),
    blk.p(""),
