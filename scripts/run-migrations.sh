...
docker exec -i paradigm-supabase-db psql -U postgres -d postgres < /root/supabase-oss/migrations/20260801212630_shopify_ops.sql
...
docker exec -i paradigm-supabase-db psql -U postgres -d postgres < /root/supabase-oss/migrations/20260803113000_pet_movie_qa_renders.sql
...
docker exec -i paradigm-supabase-db psql -U postgres -d postgres < /root/supabase-oss/migrations/20260907120000_video_factory_generation_control_plane.sql
