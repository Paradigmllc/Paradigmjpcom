  ...
  const blocks = [
    blk.callout(
      [
        ...
        T("KPI は Notion API 経由で自動更新 (run script with cron)、E),
      ],
      "☀�E�E,
      "yellow_background",
    ),
    ...
    children: [
      ...
      blk.callout(
        [
          ...
          T("\n4. スチE�Eジ間�EドラチE��でスチE�Eジ自動更新 (= Supabase 反映 in 5min cron)"),
        ],
        "📖",
        "yellow_background",
      ),
  ...
  const blocks = [
    ...
    blk.callout(
      [
        ...
        T("・5min cron で完�E双方吁Esync", { color: "gray" }),
      ],
      "🎯",
      "blue_background",
    ),
      ...
      [
        blk.callout(
          [
            ...
            T("\nCoolify env + cron + Slack 完�Eリファレンス", { color: "gray" }),
          ],
          "🔧",
          "gray_background",
        ),
