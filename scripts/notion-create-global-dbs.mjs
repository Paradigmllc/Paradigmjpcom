    ...
    description: [
      {
        ...
        text: {
          content:
            "Global market sales copy templates (8 industries ﾃ・7 issues = 56). Despair竊辿ope 5-stage frame encoded. Edits sync to Supabase via 5min cron 竊・/report/[slug] reflects in 6 min.",
        },
      },
    ],
    properties: {
