...
with desired(field_name, label_text, position_number, is_visible) as (
  values
    ...
    ('paradigmLeadStatus', '候補ステータス', 3, true),
    ('paradigmTechnology', '技術', 4, true),
    ('paradigmOpportunityScore', '機会スコア', 5, true),
    ('paradigmSmbScore', 'SMBスコア', 6, true),
    ('paradigmSourceName', '収集経路', 7, true),
    ('paradigmFormUrl', '確認済みフォーム', 8, true),
    ('paradigmOutreachTargetUrl', '営業先URL', 9, true),
    ('paradigmSourceCoverage', 'Source Coverage', 30, false),
    ('paradigmDataSources', 'Data Sources', 31, false),
    ('paradigmDataStatus', 'Data Status', 32, false),
    ('paradigmNextAction', 'Next Action', 33, false),
    ('paradigmLastError', 'Last Error', 34, false),
    ('paradigmSalesStatus', '商談ステータス', 35, false),
    ('paradigmReportUrl', 'Opportunity Brief URL', 36, false),
    ('paradigmRegionName', '地域名', 37, false),
    ('paradigmIndustryName', '業種名', 38, false),
    ('paradigmSalesMaterialUrl', '営業資料URL', 39, false),
    ('paradigmDemoUrl', 'デモURL', 40, false),
    ('paradigmCustomerPortalUrl', '顧客ポータルURL', 41, false),
...
with desired(field_name, position_number, is_visible) as (
  values
    ...
    ('paradigmLeadStatus', 3, true),
    ('paradigmTechnology', 4, true),
    ('paradigmOpportunityScore', 5, true),
    ('paradigmSmbScore', 6, true),
    ('paradigmSourceName', 7, true),
    ('paradigmFormUrl', 8, true),
    ('paradigmOutreachTargetUrl', 9, true),
    ('paradigmSourceCoverage', 30, false),
    ('paradigmDataSources', 31, false),
    ('paradigmDataStatus', 32, false),
    ('paradigmNextAction', 33, false),
    ('paradigmLastError', 34, false),
    ('paradigmSalesStatus', 35, false),
    ('paradigmReportUrl', 36, false),
    ('paradigmRegionName', 37, false),
    ('paradigmIndustryName', 38, false),
    ('paradigmSalesMaterialUrl', 39, false),
    ('paradigmDemoUrl', 40, false),
    ('paradigmCustomerPortalUrl', 41, false),
    ('createdBy', 98, false),
