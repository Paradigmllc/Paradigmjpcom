...
function generateDemoData(s, l) {
  const variants = {
    japan_entry: { company_name: "GreenTech Solutions Inc.", industry: "consulting", template_variant: "japan_entry", total_loss: "¥2,800,000", hook: "日本市場向けの表示・購入導線が不足し、購入検討者が離脱している可能性があります。", report_url: `https://paradigmjp.com/${l}/report/demo/${s}`, source_coverage: { score: 72 }, acts: [{ headline: "日本市場での信頼導線を確認", metric_label: "信頼スコア", metric_value: "8/100", body: "日本の購入者が確認する表示・問い合わせ導線を、公開情報から点検します。" }, { headline: "準備の遅れが機会損失につながる", metric_label: "計画期間", metric_value: "3-6ヶ月", body: "必要な素材、承認、決済・規制条件を先に揃えることで、実装を前に進められます。" }, { headline: "最短21営業日の公開目標", metric_label: "公開目標", metric_value: "21日", body: "Japan Entry Packageでは、条件が揃った後に日本語サイト、問い合わせ導線、運用設定を並行して進めます。" }], cta_text: "Apply for Japan Entry — $12,000 setup; $0/month managed operation for the first six months." }
  }
