...
## 3. Pitch Angle 5 軸 (pitch_angle 値・2026-05-10 拡張)

| slug | 訴求トーン | 心理トリガー | サブジェクト例 (ja) |
|------|-----------|------------|---------------------|
| `risk` | リスク型 (損失回避) | 損失回避バイアス・FOMO 反転 | 「{{company}} の trial-to-paid 経路で観察された 2 つの離脱兆候について」 |
| `opportunity` | 機会型 (前向き提案) | 達成欲求・好奇心 | 「{{company}} の Activation Rate 改善余地に関する初期所見」 |
| `competitor` | 競合迫力 (直接比較) | 同 ARR 帯プレッシャー | 「同 ARR 帯 SaaS 3 社が今四半期に着手した onboarding 改修について」 |
| `authority` | 権威・第三者所見 | Paradigm 200 社診断実績 | 「{{company}} の Web 健全性に関する第三者的所見」 |
| `social_proof` | 業界統計バンドワゴン | 中堅 73% の同調圧力 | 「中堅 SaaS の 73% が今期着手した観察項目について」 |
