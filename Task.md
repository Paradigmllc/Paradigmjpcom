...
| ⚪ AVAILABLE | - | - | - | **P18-A-FIX-1. token ハンドリング再統合** | 2026-04-30 発覚 / `[slug]` canonical 化時の orphan / `[slug]/page.tsx` 側で `slug.length === 36` UUID 判定→`/api/report/${slug}` フォールバック・API route は維持 |
| ⚪ AVAILABLE | - | - | - | **P18-D AE-PHP-2 i18n sweep** | about/services/contact/pricing/blog/faq/works/legal/privacy/4 service detail に hardcoded JP/EN 残置 (P18 リニューアル前から存在の技術債務) |
