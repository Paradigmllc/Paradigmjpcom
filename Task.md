## CURRENT STATUS - 2026-07-19 `/work`診断レポートV2完全分離（本番DB移行・初回release完了 / standalone修正の再release前 / 外部送信0）
