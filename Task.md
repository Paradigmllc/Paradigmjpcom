...
- Dependency security gate: Next.js `16.2.12`、Sharp `0.35.3`（Next.js配下もdedupe）、full `npm audit` 0 vulnerabilities、production build 552/552、Pet TypeScript/Vitest 9/9を確認した。PR #669のmerge・本番再smoke待ち。
