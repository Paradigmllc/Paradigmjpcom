      ...
      body: JSON.stringify({
        ...
        item: {
          ...
          message_review: {
            ...
            selected_index: 0,
            strategy: {
              primaryObservation: "API-first retail analytics workflow",
              whyNow: "Japan applicability remains unverified",
              japaneseSegment: "Independent Japanese retail operators",
              japanGap: "No Japanese-language evaluation path was observed",
              opportunityAngle: "Validate the buyer evaluation path",
              cta: "Ask for the right recipient",
              countryAdaptation: "Business-formal without nationality assumptions",
            },
            candidates: [
              { message: `Selected ${domain}`, openingStyle: "product-led", ctaType: "right_person" },
              { message: `Alternative ${domain}`, openingStyle: "decision-led", ctaType: "founder_forward" },
            ],
